...
public final class WaitStrategies {
    ...
    private static final class RandomWaitStrategy implements WaitStrategy {
        ...
        RandomWaitStrategy(long minimum, long maximum) {
            ...
            Preconditions.checkArgument(maximum > minimum, "maximum must be > minimum but maximum is %d and minimum is",
                maximum, minimum);
    ...
    private static final class IncrementingWaitStrategy implements WaitStrategy {
        ...
        IncrementingWaitStrategy(long initialSleepTime, long increment) {
            Preconditions.checkArgument(initialSleepTime >= 0L, "initialSleepTime must be >= 0 but is %d",
                initialSleepTime);
    ...
    private static final class ExponentialWaitStrategy implements WaitStrategy {
        ...
        ExponentialWaitStrategy(long multiplier, long maximumWait) {
            ...
            Preconditions.checkArgument(multiplier < maximumWait, "multiplier must be < maximumWait but is %d",
                multiplier);
    ...
    private static final class ExceptionWaitStrategy<T extends Throwable> implements WaitStrategy {
        ...
        ExceptionWaitStrategy(Class<T> exceptionClass, Function<T, Long> function) {
